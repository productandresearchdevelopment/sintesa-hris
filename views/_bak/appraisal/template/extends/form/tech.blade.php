<script>
  var FormTech = function() {
    ...
    me.openAddModal = function() {
      me.showFormModal('Add Technical Ability & Work Result', function(values) {
        me.store.add(values);
        me.sortStore();
      });
    };
    ...
    me.openEditModal = function(record) {
      me.showFormModal('Edit Technical Ability & Work Result', function(values) {
        record.set(values);
        me.sortStore();
      }, record.data);
    };
