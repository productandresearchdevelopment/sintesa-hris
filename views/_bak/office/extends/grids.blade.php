        ...
        me.init = function() {
                    ...
                    Ext.ajaxConfirm('Forever Remove Data', {
                      ...
                      failure: function() {
                        Ext.Msg.alert('Failed',
                          'Failed to permanently delete office.'
                        );
                      }
                    });
                  } else {
          ...
          me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [{
              ...
              {
                text: "Max Distance Allowed",
                dataIndex: 'max_distance_allowed',
                width: 150,
                flex: 1,
              }
            ],
            ...
            viewConfig: {
              ...
              listeners: {
                itemcontextmenu: function(obj, rec, node, index, e) {
                  ...
                  @if ($user->hasRoute(['office.create', 'office.update', 'office.delete', 'office.restore', 'office.forcedelete']))
