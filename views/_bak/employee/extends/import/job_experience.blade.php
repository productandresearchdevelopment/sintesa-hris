<script>
  var FormsImportJobExperience = function() {
      ...
      me.form = Ext.widget('form', {
        ...
        items: [{
          ...
          },
          {
            ...
            id: 'form-import-main-job-experience',
            layout: {
              type: 'vbox',
              align: 'stretch'
            },
          ...
          {
            xtype: 'textarea',
            id: 'form-import-response-job-experience',
            height: 200,
            allowBlank: true,
          }
        ],
    ...
    me.open = function() {
      me.show();
      me.reset();
      Ext.getCmp('form-import-response-job-experience').hide();
      Ext.getCmp('form-import-main-job-experience').show();
    }
    ...
    me.save = function() {
      ...
      Ext.Ajax.request({
        url: '{{ route('employee.import.job-experience') }}',
        rawData: formData,
        headers: {
          'Content-Type': null
        },
        success: function(response) {
          ...
          if (parsedResponse.success && parsedResponse.data) {
            if (typeof forms.jobExperience !== 'undefined' && forms.jobExperience.loadImportedData) {
              forms.jobExperience.loadImportedData(parsedResponse.data);

              Ext.getCmp('form-import-response-job-experience').show();
              Ext.getCmp('form-import-main-job-experience').hide();
              ...
              Ext.getCmp('form-import-response-job-experience').setValue(logs.join("\n"));
            } else {
              Ext.Msg.alert("Error", "Form Job Experience tidak tersedia.");
            }
