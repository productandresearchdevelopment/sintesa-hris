<script>
  var FormsImportContract = function() {
    ...
    me.init = function() {
      me.form = Ext.widget('form', {
        ...
        items: [{
          ...
          {
            xtype: 'textarea',
            id: 'form-import-response-contract',
            height: 200,
            allowBlank: true,
          }
        ],
    ...
    me.open = function() {
      me.show();
      me.reset();
      Ext.getCmp('form-import-response-contract').hide();
      Ext.getCmp('form-import-main-contract').show();
    }
    ...
    me.save = function() {
      ...
      Ext.Ajax.request({
        url: '{{ route('employee.import.contract') }}',
        rawData: formData,
        headers: {
          'Content-Type': null
        },
        success: function(response) {
          ...
          if (parsedResponse.success && parsedResponse.data) {
            if (typeof forms.contractInfo !== 'undefined' && forms.contractInfo.loadImportedData) {
              forms.contractInfo.loadImportedData(parsedResponse.data);

              Ext.getCmp('form-import-response-contract').show();
              Ext.getCmp('form-import-main-contract').hide();
              ...
              Ext.getCmp('form-import-response-contract').setValue(logs.join("\n"));
            } else {
              Ext.Msg.alert("Error", "Form Contract tidak tersedia.");
            }
