<script>
  var FormsImportEducation = function() {
    ...
    me.init = function() {
      me.form = Ext.widget('form', {
        ...
        items: [{
          ...
          {
            xtype: 'textarea',
            id: 'form-import-response-education',
            height: 200,
            allowBlank: true,
          }
        ],
    ...
    me.open = function() {
      me.show();
      me.reset();
      Ext.getCmp('form-import-response-education').hide();
      Ext.getCmp('form-import-main-education').show();
    }
    ...
    me.save = function() {
      ...
      Ext.Ajax.request({
        url: '{{ route('employee.import.education') }}',
        rawData: formData,
        headers: {
          'Content-Type': null
        },
        success: function(response) {
          ...
          if (parsedResponse.success && parsedResponse.data) {
            if (typeof forms.educationInfo !== 'undefined' && forms.educationInfo.loadImportedData) {
              forms.educationInfo.loadImportedData(parsedResponse.data);

              Ext.getCmp('form-import-response-education').show();
              Ext.getCmp('form-import-main-education').hide();
              ...
              Ext.getCmp('form-import-response-education').setValue(logs.join("\n"));
            } else {
              Ext.Msg.alert("Error", "Form Education tidak tersedia.");
            }
