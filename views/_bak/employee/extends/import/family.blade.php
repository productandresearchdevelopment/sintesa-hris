<script>
  var FormsImportFamily = function() {
    ...
    me.init = function() {
      me.form = Ext.widget('form', {
        ...
        items: [{
          ...
          {
            xtype: 'textarea',
            id: 'form-import-response-family',
            height: 200,
            allowBlank: true,
          }
        ],
    ...
    me.open = function() {
      me.show();
      me.reset();
      Ext.getCmp('form-import-response-family').hide();
      Ext.getCmp('form-import-main-family').show();
    }
    ...
    me.save = function() {
      ...
      Ext.Ajax.request({
        url: '{{ route('employee.import.family') }}',
        rawData: formData,
        headers: {
          'Content-Type': null
        },
        success: function(response) {
          ...
          if (parsedResponse.success && parsedResponse.data) {
            if (typeof forms.familyInfo !== 'undefined' && forms.familyInfo.loadImportedData) {
              forms.familyInfo.loadImportedData(parsedResponse.data);

              Ext.getCmp('form-import-response-family').show();
              Ext.getCmp('form-import-main-family').hide();
              ...
              Ext.getCmp('form-import-response-family').setValue(logs.join("\n"));
            } else {
              Ext.Msg.alert("Error", "Form Family tidak tersedia.");
            }
