<script>
  var FormsImportCareer = function() {
    ...
    me.init = function() {
      me.form = Ext.widget('form', {
        ...
        items: [{
          ...
          {
            xtype: 'textarea',
            id: 'form-import-response-career',
            height: 200,
            allowBlank: true,
          }
        ],
    ...
    me.open = function() {
      me.show();
      me.reset();
      Ext.getCmp('form-import-response-career').hide();
      Ext.getCmp('form-import-main-career').show();
    }
    ...
    me.save = function() {
      ...
      Ext.Ajax.request({
        url: '{{ route('employee.import.career') }}',
        rawData: formData,
        headers: {
          'Content-Type': null
        },
        success: function(response) {
          ...
          if (parsedResponse.success && parsedResponse.data) {
            if (typeof forms.careerInfo !== 'undefined' && forms.careerInfo.loadImportedData) {
              forms.careerInfo.loadImportedData(parsedResponse.data);

              Ext.getCmp('form-import-response-career').show();
              Ext.getCmp('form-import-main-career').hide();
              ...
              Ext.getCmp('form-import-response-career').setValue(logs.join("\n"));
            } else {
              Ext.Msg.alert("Error", "Form Career tidak tersedia.");
            }
