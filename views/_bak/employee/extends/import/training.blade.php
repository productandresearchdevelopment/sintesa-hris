<script>
  var FormsImportTraining = function() {
    ...
    me.init = function() {
      me.form = Ext.widget('form', {
        ...
        items: [{
          ...
          {
            xtype: 'textarea',
            id: 'form-import-response-training',
            height: 200,
            allowBlank: true,
          }
        ],
    ...
    me.open = function() {
      me.show();
      me.reset();
      Ext.getCmp('form-import-response-training').hide();
      Ext.getCmp('form-import-main-training').show();
    }
    ...
    me.save = function() {
      ...
      Ext.Ajax.request({
        url: '{{ route('employee.import.training') }}',
        rawData: formData,
        headers: {
          'Content-Type': null
        },
        success: function(response) {
          ...
          if (parsedResponse.success && parsedResponse.data) {
            if (typeof forms.trainingInfo !== 'undefined' && forms.trainingInfo.loadImportedData) {
              forms.trainingInfo.loadImportedData(parsedResponse.data);

              Ext.getCmp('form-import-response-training').show();
              Ext.getCmp('form-import-main-training').hide();
              ...
              Ext.getCmp('form-import-response-training').setValue(logs.join("\n"));
            } else {
              Ext.Msg.alert("Error", "Form Training tidak tersedia.");
            }
