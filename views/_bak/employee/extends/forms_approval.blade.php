<script>
  var FormsApproval = function() {
    ...
    me.init = function() {
      ...
      me.createWindowForm('Form Approval', me.form, {
        maximized: true,
        header: true,
      });
    };
    ...
    me.save = function() {
      ...
      Ext.Ajax.request({
        ...
        success: function(response) {
          Ext.Msg.alert('Success', 'Data has been approved!');
          grids.storeLoad();
          me.close();
        },
        failure: function(response) {
          Ext.Msg.alert("Error", "Failed to approve data.");
        }
      });
    };
