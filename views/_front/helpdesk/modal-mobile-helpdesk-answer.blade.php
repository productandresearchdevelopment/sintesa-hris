  ...
  <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header d-flex align-items-center gap-2">
        <h5 class="modal-title" id="ticketAnswerModalLabel">Modal Title</h5>
        <button type="button" class="btn-close" aria-label="Close" id="closeTicketAnswerModal">
        </button>
      </div>

      <div class="modal-body chat-container">
        <div class="position-relative mb-3" id="userDropdownContainerAnswer" style="display:none;">
          <div id="userDropdownAnswer" class="dropdown-menu shadow-sm"
      ...
      <div class="modal-footer">
        <div class="d-flex align-items-center w-100">
          <div class="dropdown">
            <button class="" type="button" id="dropdownFileBtn" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <input type="text" id="messageInput" class="form-control input-message"
            placeholder="Type your message..." />

          <div class="d-flex align-items-center" style="width: 50px; height: 50px;">

            <button type="button" class="" id="sendMessageBtn">
