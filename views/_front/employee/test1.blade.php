<!-- INI GK ADA TAB LANGSUNG TAB GENERAL< CONTRACT GITU -->
        ...
        switch (tab) {
          case 'general':
            content = `
                        ...
                        <button class="btn btn-primary edit-general mt-3">Edit</button>
                    `;
            break;
          ...
          case 'career':
            ...
            content = `
                        <button class="btn btn-success add-item" data-tab="career">Add</button>
          ...
          case 'citizen':
            ...
            content = `
                        <button class="btn btn-success add-item" data-tab="citizen">Add</button>
          ...
          case 'education':
            ...
            content = `
                        <button class="btn btn-success add-item" data-tab="education">Add</button>
          ...
          case 'family':
            ...
            content = `
                        <button class="btn btn-success add-item" data-tab="family">Add</button>
          ...
          case 'experience':
            ...
            content = `
                        <button class="btn btn-success add-item" data-tab="experience">Add</button>
          ...
          case 'training':
            ...
            content = `
                        <button class="btn btn-success add-item" data-tab="training">Add</button>
      ...
      function openEditModal(tab, data) {
        ...
        switch (tab) {
          case 'general':
            fields = [{
              ...
              },
              {
                ...
                key: 'organization_id',
                type: 'select',
                options: responseDataAllTables.organizations.map(o => ({
                  value: o.id,
                  label: o.name
                }))
              },
              ...
              },
              {
                ...
                key: 'division_id',
                type: 'select',
                options: responseDataAllTables.divisions.map(d => ({
                  value: d.id,
                  label: d.name
                }))
              },
          ...
          case 'career':
            fields = [{
                ...
                key: 'career_id',
                type: 'select',
                options: userEmployee.careers.map(c => ({
                  value: c.id,
                  label: c.name
                }))
              },
              ...
              },
              {
                ...
                key: 'organization_id',
                type: 'select',
                options: userEmployee.organizations.map(o => ({
                  value: o.id,
                  label: o.name
                }))
              },
              {
                ...
                key: 'placement_id',
                type: 'select',
                options: userEmployee.placements.map(p => ({
                  value: p.id,
                  label: p.name
                }))
              },
          ...
          case 'citizen':
            fields = [{
                ...
                key: 'citizen_id',
                type: 'select',
                options: userEmployee.citizens.map(c => ({
                  value: c.id,
                  label: c.name
                }))
              },
          ...
          case 'education':
            fields = [{
                ...
                key: 'education_id',
                type: 'select',
                options: userEmployee.educations.map(e => ({
                  value: e.id,
                  label: e.name
                }))
              },
              {
                ...
                key: 'major_id',
                type: 'select',
                options: userEmployee.majors.map(m => ({
                  value: m.id,
                  label: m.name
                }))
              },
          ...
          case 'family':
            fields = [{
              ...
              },
              {
                ...
                key: 'relation_id',
                type: 'select',
                options: userEmployee.relations.map(r => ({
                  value: r.id,
                  label: r.name
                }))
              },
              {
                ...
                key: 'occupation_id',
                type: 'select',
                options: userEmployee.occupations.map(o => ({
                  value: o.id,
                  label: o.name
                }))
              },
        ...
        fields.forEach(field => {
          ...
          if (field.type === 'select') {
            modalContent +=
              `<select class="form-control" name="${field.key}" ${field.disabled ? 'disabled' : ''}>`;
            ...
            modalContent += `<input type="${field.type || 'text'}"
                              class="form-control"
                              name="${field.key}"
                              value="${value}"
        ...
        $('.save-item').on('click', function() {
          ...
          const formData = {};
          fields.forEach(field => {
            formData[field.key] = $(`input[name="${field.key}"], select[name="${field.key}"]`).val();
          });

          if (id) {
            updateItem(tab, id, formData);
          } else {
            addItem(tab, formData);
          }
