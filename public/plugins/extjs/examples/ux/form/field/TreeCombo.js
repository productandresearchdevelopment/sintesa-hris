...
Ext.define('Ext.ux.form.field.TreeCombo',
        {
            ...
            setValue: function (valueInit)
            {
                ...
                if(!valueInit) valueInit = '';
                
                var me = this,
                        tree = this.tree,
                        values = (valueInit == '') ? [] : valueInit.toString().split(','),
                        valueFin = [];
                ...
                if(!me.getRawValue()) me.setRawValue(me.value);
                
                me.checkChange();
                me.applyEmptyText();
                
                var recPath = me.store.tree.getNodeById(me.value);
                if(recPath != undefined){
                    recPath = recPath.getPath();
                    me.tree.expandPath(recPath);
                    me.tree.selectPath(recPath);
                }
                ...
                me.tree = Ext.create('Ext.tree.Panel',
                        {
                            ...
                            hidden: true,
                            minHeight: 300,
                            rootVisible: (typeof me.rootVisible != 'undefined') ? me.rootVisible : false,
                            floating: true,
                            useArrows: false,
                            width: me.treeWidth,
                            autoScroll: true,
