...
@section('content')
  <div class="reset-container">
    ...
    <h1 class="reset-title">Send Verification Link</h1>
    <p class="reset-subtitle">Enter your email to send verification link</p>
    ...
    <form id="resetForm" method="POST" action="{{ route('password.email') }}">
      ...
      <button type="submit" class="btn btn-primary reset-btn">Send Reset Link</button>
    </form>
  </div>
    ...
    $(document).ready(function() {
      $('#resetForm').submit(function(e) {
        ...
        $.ajax({
          ...
          error: function(xhr) {
            showAlert('danger', 'Failed to send reset link. Please check your email address.');
          }
        });
      });
    });
