  ...
  <div class="auth-container">
    <div class="auth-left">
      <div style="width: 100%; max-width: 400px;">
        ...
        <h3 class="text-center fw-bold">Send Password Reset Link</h3>
        <p class="text-center text-muted">Enter your email to send verification link!</p>
        ...
        <form action="{{ route('password.email') }}" method="POST" class="form login">
          ...
          <div class="form-group">
            <button type="submit" class="btn w-100 text-white fw-semibold rounded-pill"
              style="background-color: #1565c0;">Send Password Reset
              Link</button>
          </div>
          <div class="form-group">
